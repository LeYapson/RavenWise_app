...
const CourseTrackingScreen = ({ navigation }) => {
    ...
    const renderCourseItem = ({ item }) => (
        ...
        <View style={styles.courseHeader}>
            ...
            <View style={[
            styles.statusBadge,
                { backgroundColor: getStatusColor(item.category) }
            ]}>
    ...
    const getStatusColor = (status) => {
        switch (status) {
            case 'web development': return COLORS.success;
            case 'framework': return "yellow";
            case 'programming': return COLORS.textSecondary;
            case 'data science': return "green";
            case 'mobile development': return "red";
            case 'design': return "blue";
            default: return COLORS.textSecondary;
        }
    };

    const getStatusDifficulty = (status) => {
        switch (status) {
            case 'web development': return 'Terminé';
    ...
    const handleStartQuiz = (course) => {
        ...
        const quiz = fetchQuizzesByCourse(course.id);
